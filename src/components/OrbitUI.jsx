    ...
    <section style={{
      ...
      <div style={{
        ...
        <div style={{ 
            ...
            {/* 🔴 修改点：第一行改成垂直居中对齐，并加破折号 */}
            <div style={{ 
                display: 'flex', 
                alignItems: 'center', // 垂直居中 (Center Collinear)
                gap: '15px' 
            }}>
                {/* 缩写 (LEO) */}
                <h1 style={{ 
                ...
                <span style={{ 
                    ...
                    fontWeight: '300',
                    lineHeight: '1',
                    paddingBottom: '5px' // 视觉微调，让横线看起来更居中
                }}>
                    —
                </span>
                ...
                {/* 全称 (Low Earth Orbit) */}
                <h2 style={{ 
                    color: 'rgba(255,255,255,0.8)', // 稍微调亮一点
                    fontSize: '1.1rem', // 稍微调大一点以匹配中心对齐的视觉平衡
                    margin: '0', 
                    fontWeight: '600',
                    fontFamily: 'sans-serif',
                    letterSpacing: '0.5px'
